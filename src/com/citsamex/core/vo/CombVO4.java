...
public class CombVO4 {
	...
	private String xssdm;
	private String xss;
	private String pjtgfe;
	...
	public String getXssdm() {
		return xssdm;
	}

	public void setXssdm(String xssdm) {
		this.xssdm = xssdm;
	}
	...
	public String getPjtgfe() {
		return pjtgfe;
	}

	public void setPjtgfe(String pjtgfe) {
		this.pjtgfe = pjtgfe;
	}
